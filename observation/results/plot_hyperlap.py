...
def plot_degree(data_name, fname, save_name, x_name, y_name):
    ...
    gen_path = dir_path + fname + '_uniform.txt'
    ...
    hypercl_path = dir_path + fname + '_hypercl.txt'
    ...
    plt.scatter(hyperclx, hypercly, s=40, alpha=0.8, label='hypercl', c=color_list[3])
    ...
    plt.tight_layout()
    plt.savefig(dir_path + 'old_' + save_name + '_' + data_name + '.jpg', bbox_inches='tight')
    # plt.show()  
...
def plot_density(data_name, fname, save_name):
    ...
    plt.scatter(hypercl_x, hypercl_y, label='hypercl', c=color_list[3], alpha=0.8, s=40)
...
def plot_homogeneity(data_name, fname, x_name, y_name, save_name):
    ...
    # gen
    gendata = pd.read_csv(dir_path + fname + '_uniform.txt')
    ...
    # hypercl
    hypercldata = pd.read_csv(dir_path + fname + '_hypercl.txt')
    ...
    plt.scatter(hypercl_x, hypercl_y, s=40, alpha=0.8, c=color_list[3], label='hypercl')
